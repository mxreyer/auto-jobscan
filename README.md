...
Three files describe you, and everything else is machinery:

| file | what it holds |
|---|---|
| `profile.md` | what you have done — **and what you have not** |
| `SCORING.md` | how to weigh a posting against that |
...
the material she was built from — and **her `profile.md` and `SCORING.md` were
generated by `/jobscan-setup` from that material, not written by hand.** Run
the skill against `examples/material` and compare. Or just watch the scan run:

    cp examples/config.json config.json
    cp examples/profile.md   profile.md
    cp examples/SCORING.md   SCORING.md
...
| `SCORING.md` | the rubric — read this before changing how scoring works |
